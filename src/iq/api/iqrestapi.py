...
def post(function, waittime=1, **arguments):
    ...
    **arguments
    ...
    """
    r_json = _post(_base_url, _state.url_dict, _state.auth, function, waittime=waittime, **arguments)
...
def _post(base_url, url_dict, auth, function, waittime=1, **arguments):
    ...
    **arguments
    ...
    -------
    dict
        Parsed JSON response body containing the computation result. It has the following format:
        {
